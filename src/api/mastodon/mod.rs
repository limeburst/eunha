...
pub fn router(state: AppState) -> Router<AppState> {
    let auth_required = Router::new()
        ...
        .route("/api/v1/notifications/requests/accept", post(notifications::accept_all_notification_requests))
        .route("/api/v1/notifications/requests/dismiss", post(notifications::dismiss_all_notification_requests))
        .route("/api/v1/notifications/requests/merged", get(notifications::get_notification_requests_merged))
        ...
        .route("/api/v1/notifications/policy", get(notifications::get_notification_policy_v1).patch(notifications::update_notification_policy_v1))
        ...
        .route("/api/v1/admin/accounts/{id}/sensitive", post(admin::sensitive_account))
        .route("/api/v1/admin/accounts/{id}/unsensitive", post(admin::unsensitive_account))
        .route("/api/v1/admin/accounts/{id}/action", post(admin::account_action))
        ...
        .route("/api/v1/admin/reports/{id}/assign_to_self", post(admin::assign_report_to_self))
        .route("/api/v1/admin/reports/{id}/unassign", post(admin::unassign_report))
        ...
        .route("/api/v1/admin/domain_blocks/{id}", get(admin::get_admin_domain_block).patch(admin::update_admin_domain_block).delete(admin::delete_domain_block))
        ...
        .route("/api/v1/admin/ip_blocks/{id}", get(admin::get_ip_block).patch(admin::update_ip_block).delete(admin::delete_ip_block))
        ...
        .route("/api/v1/admin/trends/tags/{id}/approve", post(admin::admin_approve_trending_tag))
        .route("/api/v1/admin/trends/tags/{id}/reject", post(admin::admin_reject_trending_tag))
        .route("/api/v1/admin/trends/statuses/{id}/approve", post(admin::admin_approve_trending_status))
        .route("/api/v1/admin/trends/statuses/{id}/reject", post(admin::admin_reject_trending_status))
        .route("/api/v1/admin/trends/links/{id}/approve", post(admin::admin_approve_trending_link))
        .route("/api/v1/admin/trends/links/{id}/reject", post(admin::admin_reject_trending_link))
        .route("/api/v1/admin/tags", get(admin::list_admin_tags))
        .route("/api/v1/admin/tags/{id}", get(admin::get_admin_tag).patch(admin::update_admin_tag))
        .route("/api/v1/admin/canonical_email_blocks", get(admin::list_canonical_email_blocks).post(admin::create_canonical_email_block))
        .route("/api/v1/admin/canonical_email_blocks/test", post(admin::test_canonical_email_block))
        .route("/api/v1/admin/canonical_email_blocks/{id}", get(admin::get_canonical_email_block).delete(admin::delete_canonical_email_block))
        ...
        .route("/api/v1/profile", get(accounts::get_profile).patch(accounts::update_credentials).put(accounts::update_credentials))
        // Followed tags
        ...
        .route("/api/v1/tags/{name}/feature", post(featured_tags::feature_tag_by_name))
        .route("/api/v1/tags/{name}/unfeature", post(featured_tags::unfeature_tag_by_name))
        // Featured tags
    ...
    let public = Router::new()
        ...
        .route("/api/v1/statuses/{id}/translate", post(statuses::translate_status))
        // Polls (public read)
        ...
        .route("/api/v1/announcements/{id}/reactions/{name}", put(announcements::add_reaction).delete(announcements::remove_reaction))
